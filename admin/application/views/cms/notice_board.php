...
<div class="right-wrapper">
 <div id="TabbedPanels1" class="TabbedPanels">
                                <ul class="TabbedPanelsTabGroup">
                                  ...
                                  <li class="TabbedPanelsTab" tabindex="0" >Notice Board
        </li>
		...
		<form method="post"  name="deposit"  enctype="multipart/form-data" action="<?php print WEB_URL_ADMIN?>admin/add_notice" onsubmit="return valid(this)">
		<input type="hidden" name="id" value="<?php echo $id ;?>" />
                                  <table width="918" height="57" border="0">
  <tr><td>Notice Title</td><td><input type="text" name="notice_title" id="notice_title" class="getfields" value="<?php if(isset($notice_list)){if($notice_list != ''){ echo $notice_list->notice_title ;}}?>" /></td></tr>
  
	 <tr><td>Upload Image</td><td><input type="file" name="notice_image" id="notice_image" class="getfields" />&nbsp;&nbsp;&nbsp;Upload a suitable Image to define Notice </td></tr>
     
      <tr><td>Notice Content</td><td><textarea name="notice_content" class="getfields"><?php if(isset($notice_list)){if($notice_list != ''){ echo $notice_list->notice_content ;}}?> </textarea></td>
      </tr>
        
     <tr><td><input type="image" src="<?php echo WEB_DIR_ADMIN ?>images/update_btn.png"  /></td>
     <td><img src="<?php echo WEB_DIR_ADMIN ?>excursionimages/<?php echo $notice_list->img_banner?>" height="80" width="120" /></td></tr>

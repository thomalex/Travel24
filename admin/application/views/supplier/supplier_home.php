		...
		<?php }?>
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;">
                   ...
                   <input name="city" id="city" class="getfields" style="width:350px;" type="text" value="<?php if($this->session->userdata('apt_id')!=''){?><?php $city = $this->Supplier_Model->get_city($sup->city); if($city)echo $city; else echo $sup->city ?><?php }?>">
				<script type="text/javascript">
	    var options = {

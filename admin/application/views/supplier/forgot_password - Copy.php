...
<body style="background:#232222 !important;">
    ...
    <div class="wrapper" style="width:380px; margin:0 auto;" >
          	...
          	<div class="login-bg-forgot">
                ...
                <div style="padding:10px; text-align:justify;">If you forget your password or your account has been locked , enter your email address in the box below. Your password will be sent to your registered email address.</div>
                
                <div class="login-inner-input-boxpass">
                <input name="user" id="user" type="text" style="width:260px ; height:24px; background-color:transparent; border:none; margin-bottom:10px; margin-top:14px;" onblur="return check_email(this.value)" />

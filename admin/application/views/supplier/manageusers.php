...
<div class="wrapper">
 ...
 <div id="container_warpper" >       
       ...
       <?php  $this->load->view('supplier/leftbar');?>
        ...
        <div class="content">
         <div class="headersuplr_new1">Users List<span style=" width:20%;float:right; font-size:13px; text-align:right;"><a href="<?php echo WEB_URL_ADMIN?>admin/apart_list" style="font-size:13px; color:#F69F3A;">Go to List</a></span>
        </div>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0" style=" background-color:#ccc;">
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td class="add-your-property" align="right" ><a href="<?php echo WEB_URL_ADMIN?>supplier/add_user/1" style="margin-bottom:5px; width:120px;" >Add New User</a></td>
  </tr>
</table>
  ...
  <?php if(isset($users)){if($users!=''){ foreach($users as $row){?>
               
              <tr>
                <td align="center" style="border-bottom:1px solid #dcdcdc;">
                    <span ><strong><?php echo $row->lname;?></strong></a></span>
                </td>
                <td align="center" style="border-bottom:1px solid #dcdcdc;">
                  <span><?php echo $row->email;?></span>
                </td>
                <td align="center" style="border-bottom:1px solid #dcdcdc;">
                    <span ><a href="<?php echo WEB_URL_ADMIN?>supplier/edit_user_manage/<?php echo $row->manage_users_id?>"><img src="<?php echo WEB_DIR_ADMIN?>/images/edit_icon.jpg" title="click to edit" width="20" height="20"></a></span>
                </td>
               
                
               
                <td align="center" style="border-bottom:1px solid #dcdcdc;"><a href="<?php echo WEB_URL_ADMIN?>supplier/delete_user/<?php echo $row->manage_users_id;?>"  onclick="return confirm('Are you sure want to delete this user?')"><img src="<?php echo WEB_DIR?>/supplier_includes/images/delete.png" alt=" Delete" title=" Delete" /></a></td>
            </tr>
        <?php }}}?>  
        </tbody>
    </table>

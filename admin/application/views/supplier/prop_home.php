...
<body>
  ...
  <!--  <div id="sidebar-position">
    ...
    <!-- Content wrapper -->
	<form method="post" action="<?php echo WEB_URL?>supplier/general_info" id="general_contact" name="general_contact">
    <div class="wrapper">
        <!-- Content -->
        <div class="content">
            <!-- Dynamic table -->
            <div class="table">
                <div id="HeaderNav_title">
					...
					<div class="hidden_head">&nbsp;</div>
                        <div class="title">
                            <h5>
                                <span id="ctl00_xlblPageName" style="width:80%; float:left; display:block;">General & Contact Information</span>
		 ...
		 <tr>
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;" width="57%">
                    ...
                    <select name="country" id="country" class="subgetselectfields" <?php if($this->session->userdata('apt_id')){?> disabled="disabled" <?php }?> style="width:360px;">
	<?php foreach($country as $cont){?>
		<option value="<?php echo $cont->country_id;?>" <?php if($cont->country_id == $cnt){?> selected="selected"<?php }?>><?php echo $cont->name;?></option>
		<?php }?>
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;">
                   ...
                   <input name="city" id="city" class="getfields" style="width:350px;" <?php if($this->session->userdata('apt_id')!=''){?> readonly="readonly" <?php }?> type="text" value="<?php if($this->session->userdata('apt_id')!=''){?><?php $city = $this->Supplier_Model->get_city($sup->city); if($city)echo $city; else echo $sup->city ?><?php }?>">
				<script type="text/javascript">
	    var options = {
	    ...
	    var as_json = new AutoSuggest('city', options);
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;">
                   ...
                   <input name="apt_name" id="apt_name" class="getfields" <?php if($this->session->userdata('apt_id')){?> readonly="readonly" <?php }?>style="width:350px;" type="text" value="<?php if(isset($apt)){ if($apt!=''){echo $apt->apartment_name;}} ?>">

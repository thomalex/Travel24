...
<div id="container_warpper" >       
       ...
       <?php  $this->load->view('supplier/leftbar');?>
        ...
        <div class="content" >
         <div class="headersuplr_new1">Add User<span style=" width:20%;float:right; font-size:13px; text-align:right;"><a href="<?php echo WEB_URL_ADMIN?>admin/apart_list" style="font-size:13px; color:#F69F3A;">Go to List</a></span>
        </div>
        <div style="float:left; width:100%;">
 <form  method="post" id="add_user" name="add_user" action="<?php echo WEB_URL_ADMIN?>supplier/add_user_perm">

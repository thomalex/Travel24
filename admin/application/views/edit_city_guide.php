...
//            config.height = 1800;
 ...
 <div id="container_warpper" style="padding-bottom:00px;" >
   <form action="<?php echo WEB_URL_ADMIN?>admin/update_city_guide/<?php echo $res->city_guides_id ?>" method="post" >
         ...
         <tr>
           ...
           <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
               ...
               <td>:</td>
               <td><input name="title" id="title" type="text" size="30" value="<?php if(isset($res)){if($res != ''){ echo $res->city_name; }}?>" readonly="readonly" /></td>
             </tr>
           </table></td>
         </tr>
         <tr>

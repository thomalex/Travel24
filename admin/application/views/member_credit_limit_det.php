...
<form method="post" id="user_registration_form" action="<?php echo WEB_URL_ADMIN?>admin/update_member_crdit">
...
<div id="inner-pagetit" style="background-color:#333333; color:#fff; height:30px; padding:10px; font-weight:bold; font-size:20px;"><span style="padding-left:10px">Credit Limit Management</span></div>
...
<tr>
	<td>Credit Limit : </td>
	<td><input type="text" value="<?php print $agent->account_balance; ?>" name="account_balance"  /></td>
</tr>
...
<tr>
	<td>Update Limit : </td>
	<td><select name="update_limit" id="update_limit" onchange="show_amount(this.value)">
    		<option value=""> - Select Update Limit - </option>
    		<option value="Add">Add Credit Limit</option>
            <option value="Reduce">Reduce Credit Limit</option>
    	</select></td>
</tr>
<tr id="limit" style="display:none;">
	<td><span id="add_limit" style="display:none">Add Limit</span> <span id="reduce_limit" style="display:none;">Reduce Limit</span>: </td>
	<td><input type="text" name="amount"  /></td>
</tr>
<tr>
	<td>Remarks : </td>
	<td><textarea name="remarks" rows="10" cols="30"><?php print $agent->remarks; ?></textarea></td>
</tr>

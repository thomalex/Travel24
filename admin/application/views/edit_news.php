...
<form method="post" id="user_registration_form" action="<?php echo WEB_URL_ADMIN?>admin/update_news/<?php echo $id; ?>">
...
<tr>
	<td>News For</td>
	<td><input type="radio" value="B2B" name="news_for" checked="checked" <?php if($news->news_for =='B2B') { echo "checked"; } ?>  /> B2B <input type="radio" value="B2C" name="news_for"  <?php if($news->news_for =='B2C') { echo "checked"; } ?> /> B2C</td>
</tr>
...
<tr>
	...
	<td><select name="show_at" style="width:180px;">
        ...
        <option value="News" <?php if($news->show_at =='News') { echo "selected"; } ?>>News</option>
        <option value="Testimonials" <?php if($news->show_at =='Testimonials') { echo "selected"; } ?>>Testimonials</option>
        </select></td>
</tr>
<tr>
	<td>News Title</td>
	<td><input type="text" style="width:180px;" name="news_title" id="news_title"  value="<?php echo $news->new_title; ?>" /></td>
</tr>
<tr>
	<td>Message</td>
	<td><textarea name="message" id="message" rows="10" cols="50"><?php echo $news->message; ?></textarea></td>
</tr>


<tr>
<td></td>
<td><input type="image" src="<?php echo WEB_DIR_ADMIN?>images/update_btn.png"   name="submit_agent" value="Edit News"/></td>
 </tr>
</table>
</td>
<td valign="top">

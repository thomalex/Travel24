...
<div id="container_warpper" style="padding-bottom:50px; margin-top:50px;" >
  ...
  <tr style="background-image:url(../../images/searchbg.jpg); background-repeat:repeat-x; color:#333; border:solid 1px #ccc;  font-size:14px; text-align:center;">
    <td colspan="4" height="30">Hotel Booking Details</td>
  </tr>
  <form name="markup"  method="post" action="<?php print WEB_URL_ADMIN ?>admin/search_book_hotel" >
  <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    <td height="20" colspan="4">&nbsp;</td>
    </tr>
  <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    <td height="30">Status : </td>
    <td align="left"><select name="status" class="field"  style="width:170px;">
    ...
    <td align="left"><input type="text"  name="transaction_id"  class="field" style="width:150px;" value="" /></td>
  </tr>
  <?php $cities = $this->Home_Model->cities(); ?>
   <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    ...
    <td align="left"><input type="text"  name="customer_name"  class="field" value="" style="width:150px;" /></td>
  </tr>
   <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
     <td height="30">Booked Date From : </td>
     <td align="left"><input type="text" name="book_from"  class="field" id="sd"  style="width:150px;"/></td>
     <td height="30">Booked Date To : </td>
     <td align="left"><input type="text" name="book_to" id="ed"  class="field" style="width:150px;"/></td>
   </tr>

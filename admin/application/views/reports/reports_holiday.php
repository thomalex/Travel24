...
<div id="container_warpper" style="padding-bottom:50px; margin-top:50px;" >
  ...
  <div style="margin:auto; width:790px; height:auto; margin-top:20px; overflow:hidden;">
  ...
  <tr style="background-color:#505e91; border:solid 1px #ccc; background-image:url(../../images/searchbg.jpg); background-repeat:repeat-x; color:#333; font-size:14px; text-align:center;">
    <td colspan="4" height="30">Holiday Booking Details</td>
  </tr>
  <form name="markup"  method="post" action="#" >
  <tr align="left" style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
  ...
  <?php $cities = $this->Home_Model->cities(); ?>
   ...
   <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    ...
    <td align="left"><input type="text" name="book_to" id="ed" style="width:150px;" class="field"/></td>
  </tr>
  <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    <td height="30">Customer Name : </td>
    <td align="left"><input type="text" name="customer_name" id="customer_name" style="width:150px;" class="field" /></td>

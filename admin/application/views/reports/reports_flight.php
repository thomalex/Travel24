...
<div id="container_warpper" style="padding-bottom:50px; margin-top:50px;" >
  ...
  <tr style="  border:solid 1px #ccc; background-image:url(../../images/searchbg.jpg); background-repeat:repeat-x; color:#333; font-size:14px; text-align:center;">
    <td colspan="4" height="30">Flight Booking Details</td>
  </tr>

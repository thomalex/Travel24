...
<div id="container_warpper" style="padding-bottom:50px; margin-top:50px;" >
   <div class="left_menu_sub">
		<?php $this->load->view('reports/left_menu'); ?>
	</div>
   <script type="text/javascript">
  function abc()
  {
  ...
  <div style="margin:auto; width:770px; height:auto;  margin-top:20px; overflow:hidden;">
 
  <div id="view_comm" style="width:750x; height:auto; overflow:hidden; border:solid 1px #ccc; margin-left:20px;">
  <table width="100%" border="0" cellpadding="5" cellspacing="0"  >
  <tr style="background-color:#505e91; border:solid 1px #ccc; background-image:url(../../images/searchbg.jpg); background-repeat:repeat-x; color:#333; font-size:14px; text-align:center;">
    <td colspan="4" height="30">Bus Booking Details</td>
  </tr>
  ...
  <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    ...
    <td align="left"><select name="status"  style="width:170px;" class="field">
    ...
    <td align="left"><input type="text"  name="transaction_id" style="width:150px;" class="field" value="" /></td>
  </tr>
  <?php $cities = $this->Home_Model->cities(); ?>
   <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    <td height="30">Origin : </td>
    <td align="left"><select name="city" style="width:170px;" class="field">
    		<option value="">Select</option>
   ...
   <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    ...
    <td align="left"><input type="text" name="book_from" id="sd" style="width:150px;" class="field" /></td>
     <td height="30">Booked Date To : </td>
    <td align="left"><input type="text" name="book_to" style="width:150px;" class="field" id="ed" /></td>
  </tr>
  <tr style="border:solid 1px #ccc; color:#000; font-size:14px; text-align:center;">
    <td height="30">Customer Name : </td>
    <td align="left"><input type="text" name="customer_name" style="width:150px;" class="field" id="customer_name" /></td>

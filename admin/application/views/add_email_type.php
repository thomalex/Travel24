...
<div id="container_warpper" style="padding-bottom:50px;" >
   <div style="background:#EFA146; color:#000; padding:4px;" >Add Email Type</div>
  ...
  <span style="color:#fff; background:#F69F3A; width:150px; float:left; text-align:center; cursor:pointer;" onclick="return abc();">Add Email Title</span> 
  </div>
  ...
  <tr style="background-color:#333; border:solid 1px #ccc; color:#fff; font-size:14px; text-align:center;">
    <td>Add Email Title</td>
  </tr>
   </table>

   <form name="add_email" id="add_email" id="add_comm" action="<?php print WEB_URL_ADMIN?>admin/add_email_type/<?php if(isset($email)){if($email != ''){echo $email->email_types_id;}}?> " method="post"  >

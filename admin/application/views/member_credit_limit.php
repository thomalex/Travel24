...
<form method="post" id="user_registration_form" action="<?php echo WEB_URL_ADMIN?>admin/get_agent_detai">
...
<tr>
	...
	<td><select name="user">
            ...
            <?php if(isset($agent)) { if($agent != '') { foreach($agent as $row) { ?>
            	<option value="<?php echo $row->agent_id; ?>"><?php echo $row->agent_name.", ".$row->agency_name; ?> </option>
            <?php } } } ?>
    	</select></td>
</tr>

...
<div style=" text-align:center; font-size:18px; color:#000; padding-top:10px;" >Offline Offer Requests</div>
...
<tr style="background-color:#333333; height:30px;">
    ...
    <td align="center" valign="middle" style="border-right:1px solid #E6E6E6; border-bottom:1px solid #E6E6E6; padding:0 5px 0 5px; color:#333; "><?php print $row->return_date;?></td>
	  ...
	  <?php echo "<span style='color:#000; font-weight:bold;'>No Offer Requests found</span>";?></td></tr>
	  <?php }}
	  ?>

...
<div style=" text-align:center; font-size:18px; color:#000; padding-top:10px;" >Offline Flight Requests</div>
...
<tr style="background-color:#333333; height:30px;">
	...
	<td width="100" height="30" align="center" valign="middle" style="border-right:1px solid #FFF; padding:0 5px 0 5px; "><b>Email Id</b></td>
     ...
     <td align="center" valign="middle" style="border-right:1px solid #FFF; padding:0 5px 0 5px; "><b>Flight Type</b></td> 
    ...
    <td align="center" valign="middle" style="border-right:1px solid #E6E6E6; border-bottom:1px solid #E6E6E6; padding:0 5px 0 5px; color:#333; "><?php print $row->bus_type;?></td>
	  ...
	  <?php echo "<span style='color:#000; font-weight:bold;'>No Flight Booking Requests found</span>";?></td></tr>
	  <?php }}
	  ?>

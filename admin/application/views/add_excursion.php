...
<body>
 ...
 <form method="post" name="frm1"  enctype="multipart/form-data" action="<?php print WEB_URL_ADMIN?>admin/insert_excursion" > <!--onsubmit="return citydesc();"-->
    ...
    <table class="tableStatic" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<script type="text/javascript">
	    var options = {
		script:"<?php print WEB_DIR; ?>test_h.php?json=true&",varname:"input",json:true,callback: function (obj) { document.getElementById('city_hide').value = obj.id; } };
	    var as_json = new AutoSuggest('testinput', options);
           ...
           <tr>
            ...
            <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;">
                    <textarea class="getfields" name="holiday_plan" id="holiday_plan" style="height:70px; width:350px;"></textarea> 
                </td>
            </tr>
            <tr>
                <td style="border-bottom:1px solid #dcdcdc;"  width="43%">
           ...
           <!-- <tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td style="border-bottom:1px solid #dcdcdc;">
                <textarea type="text" name="itinary_basic" id="itinary_basic" class="getfields" ></textarea>
                </td>
            </tr>
            <tr>

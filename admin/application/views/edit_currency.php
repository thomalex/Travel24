...
<?php /*?>        <?php echo WEB_URL_ADMIN?>admin/add_subadmin<?php */?>
   ...
   <form name="add_currency" id="add_currency" action="<?php echo WEB_URL_ADMIN?>/admin/update_currency_details/<?php echo $edit_currency->currency_id?>" method="post">
    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #ccc; border-radius:8px 8px 0px 0px;  margin-top:20px; background:#fff;">
    
    <tr><td colspan="2" style="background:#333; color:#fff; font-size:20px; text-align:center;height:30px; border-radius:6px 6px 0px 0px;">Edit Currency</td></tr>
  ...
  <tr>
    ...
    <td width="400" style="padding:5px 0 15px 10px;">
      <input name="currency_code" id="currency_code" type="text"  class="supplier_text291" value="<?php echo $edit_currency->currency?>" style="width:200px;"/>
 ...
 <tr>
    ...
    <td width="400" style="padding:5px 0 15px 10px;">
	<input name="currency_name" id="currency_name" type="text"  class="supplier_text291" value="<?php echo $edit_currency->currency_name?>" style="width:200px;">
  ...
  <tr>
    ...
    <td width="400" style="padding:5px 0 15px 10px;">
	   ...
	   <input name="amount" id="amount" type="text" class="supplier_text291" value="<?php echo $edit_currency->currency_value?>" style="width:200px;" />
</td>
  </tr>
  <tr>

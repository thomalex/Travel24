...
<body>
    ...
    <div class="wrapper">
        ...
        <tbody>
         <tr>
          <td colspan="13" align="right" class="add-your-property" style="border-bottom:1px solid #dcdcdc; width:200px;"><a href="<?php echo WEB_URL_ADMIN ?>admin/select_dome_excursion"  style="color:#fff; width:160px;"/>Select Domestic Holiday</a></td>
          </tr>
          <tr>

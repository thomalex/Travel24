...
<title> List Holiday Hotels</title>
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="table" style="margin-top:20px;">
                <div id="HeaderNav_title">
                    <div class="fixed_HeadNav_title" style="position:absolute;">
                        ...
                        <div class="title">
                            <h5>
                                <span id="ctl00_xlblPageName" style="width:80%; float:left; display:block;">List Holidays Hotels</span>
        ...
        <tbody>
         <tr>
          <td colspan="13" align="right" class="add-your-property" style="border-bottom:1px solid #dcdcdc;"><a href="<?php echo WEB_URL_ADMIN ?>admin/add_holiday_hotel/<?php echo $ex_id; ?>"/>Add Hotel</a></td>
          </tr>
          <tr>
          <td colspan="13" align="center" height="30" class="add-your-property" style="border-bottom:1px solid #dcdcdc; font-weight:bold; font-size:18px; color:#800000">Hotels Available for <?php echo $ex_det->ex_name; ?></td>
          </tr>
               <tr>
				...
				<td align="center" class="inner-span-heading1" style="border-bottom:1px solid #dcdcdc;">
                    <strong><span >Hotel Name  </span>
                 </strong></td>
                 
                   
                 
                 <td align="center" class="inner-span-heading1" style="border-bottom:1px solid #dcdcdc;">
                  <strong><span> Duration in Hotel</span>
                 </strong></td>
                 
                 <td align="center" class="inner-span-heading1" style="border-bottom:1px solid #dcdcdc;">
                  <strong><span> Star Rate</span>
                 </strong></td>
                 
                 
                 
                 <td align="center" class="inner-span-heading1" style="border-bottom:1px solid #dcdcdc;">
                  <strong><span> Meal Plan</span>
                 </strong></td>
			 ...
			 $m = 1;
				if(isset($hotels)){ if($hotels != '') { ?>
                      ...
                      <tr>
                            ...
                            <td align="center" style="border-bottom:1px solid #dcdcdc;">
                              <span><?php echo $row->star_rate; ?></span>
                            </td>
                            
                          
                            
                            <td align="center" style="border-bottom:1px solid #dcdcdc;">
                              <span><?php echo $row->meal_plan; ?></span>
                            </td>
                             ...
                             <span> - </span>
                              ...
                              <?php }else{?>
                              <span><a href="<?php print WEB_URL_ADMIN ?>admin/delete_holiday_hotel/<?php echo $row->id; ?>/<?php echo $row->ex_id; ?>" ><img src="<?php echo WEB_DIR?>supplier_includes/images/delete.png" alt=" Delete" title=" Delete" onclick="return confirm('Are you sure want to delete this Package?')"  /></a></span>
                              <?php }?>
                            </td>
                      </tr>
					  <?php

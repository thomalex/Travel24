...
<div class="right-wrapper">
 <div id="TabbedPanels1" class="TabbedPanels">
                                <ul class="TabbedPanelsTabGroup">
                                  ...
                                  <li class="TabbedPanelsTab" tabindex="0" >Mails and Reminders
        </li>
		...
		<form method="post"  name="deposit"  enctype="multipart/form-data" action="<?php print WEB_URL_ADMIN?>admin/send_mail_super" onsubmit="return valid(this)">

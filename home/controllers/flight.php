...
xmlns:sec="http://xml.amadeus.com/2010/06/Security_v1" <!-- Omitted Namespaces-->">
 ...
 $created = gmdate('Y-m-d\TH:i:s\Z');
  ...
  // $created  = date('c');
   ...
   $passwordDigest1 = base64_encode(sha1($nonce.$created.sha1('AMADEUS'), true));
  //$passwordDigest = base64_encode(sha1($nonce +  $timestamp + sha1('AMADEUS')));
		...
		<wsa:Action soapenv:mustUnderstand="1">http://webservices.amadeus.com/FMPTBQ_14_1_1A</wsa:Action>
		...
		<wsa:To soapenv:mustUnderstand="1">https://nodea1.test.webservices.amadeus.com/1ASIWTRVTTZ</wsa:To>
	</soapenv:Header>			  
			...
			<Fare_MasterPricerCalendar xmlns="http://xml.amadeus.com/FMPCAQ_08_2_1A">
                ...
                $request_stirng = "FMPCAQ_08_2_1A";
                var_dump($Fare_MasterPricerTravelBoardSearch);

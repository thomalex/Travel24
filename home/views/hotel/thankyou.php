...
<div class="title" > <span class="blue"><?php //echo $agent_details[0]['webmaster_name']?></span></div>
    ...
    width: 950px;">
                    	...
                    	<div class="thankyou_left_section">
                       	  <div style="width:390px; height:auto; float:left; margin:22px 20px 0 20px;">
                                ...
                                You can check your bookings on your dashboard.<div class="thankyou_summary_main_title" style="background-color: red; color: #FFFFFF; float: left;font-size: 24px; height: 30px;padding: 7px 0 0 10px; width: 380px; margin-top: 10px;">Payment Details</div>
                            <div class="thankyou_summary_content_box" style="width:323px;">
                            	<div class="summary_div">
                                	<div class="thankyou_summary_label" style="width:138px; margin-left: 0px;">Transaction Number.</div>
                                    <div class="thankyou_summary_result" style="width:223px;"><?php echo $payment_det->transactionNo; ?></div>
                                    
                                   
                                </div>
                                <div class="summary_div">
                                	<div class="thankyou_summary_label" style="width:138px; margin-left: 0px;">Card Type.</div>
                                    <div class="thankyou_summary_result" style="width:223px;"><?php echo $payment_det->cardType; ?></div>
                                    
                                  
                                </div>
                                <div class="summary_div">
                                	<div class="thankyou_summary_label" style="width:138px; margin-left: 0px;">Receipt Number.</div>
                                    <div class="thankyou_summary_result" style="width:223px;"><?php echo $payment_det->receiptNo; ?></div>
                                    
                                  
                                </div>
                                <div class="summary_div">
                                	<div class="thankyou_summary_label" style="width:138px; margin-left: 0px;">Transaction Message.</div>
                                    <div class="thankyou_summary_result" style="width:223px;"><?php echo $payment_det->message; ?></div>
                           ...
                           <img src="<?php print WEB_DIR?>images/back2dashboard.png" width="161" height="38" alt="Back to dashboard" />
                            ...
                            &nbsp;
                           <?php /*?> <?php echo WEB_URL?>home/print_voucher/<?php echo $hotel->booking_no; ?><?php */?>
...
<br />
						...
						<div class="thankyou_right_panel">

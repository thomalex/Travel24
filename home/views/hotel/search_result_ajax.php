...
<?php if($row->api_name != 'hotelspro') { 
    ...
    $url = WEB_URL.'home/prop_detail/'.$row->hotel_id.'/'.$row->result_id.'/2'.'/'.$row->result_id;
	   ...
	   if($row->api_name == 'hotelspro') { 
	   if(isset($hotel_det->HotelName) && $hotel_det->HotelName != '') { 
	   ?>
       
       <a href="<?php echo WEB_URL ?>home/prop_detail/<?php echo $row->hotel_id; ?>/<?php echo $row->result_id; ?>/2/<?php echo $row->result_id; ?>">
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="18" style="color:#202020; font-size:12px;"><?php if($row->api_name == 'hotelspro') { echo $hotel_det->Destination.", ".$hotel_det->Country; } else { echo $row->location; }?> <?php //echo $row->description; ?></td>
       	...
       	<tr>
        <td height="18" style="color:#0084ba; font-size:12px;"><span class="rollover"><?php echo $hotel_det->HotelAddress; ?> </span> </td>
      </tr>
    </table></td>
     ...
     <span style="margin-top:5px; float:left;"><a href="<?php echo WEB_URL ?>home/prop_detail/<?php echo $row->hotel_id; ?>/<?php echo $row->result_id; ?>/2/<?php echo $row->result_id; ?>"><input type="image" src="<?php echo WEB_DIR ?>images/hotels/select.jpg" /></a></span></a>
     <?php }
	   }
	  else
	  {
		  ?>
          <a href="<?php echo WEB_URL ?>home/prop_detail/<?php echo $row->hotel_id; ?>/<?php echo $row->hotel_name; ?>/1/<?php echo $row->result_id; ?>">
<div class="hotel_result1 " style="text-decoration:none;" >
    <table width="730">
    <tr>
      <td width="8">&nbsp;</td>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <?php } ?>
       	...
       	<tr>
        <td height="18" style="color:#0084ba; font-size:12px;"><span class="rollover"><?php if($row->description != '') { ?><?php echo $row->description; ?>&nbsp;</a><?php }?> </span> </td>
      </tr>
    </table></td>
     <!--rate part plus book button-->
     <td width="140" align="left">
     ...
     <?php }?>
      ...
      <span style="margin-top:5px; float:left;"><a href="<?php echo WEB_URL ?>home/prop_detail/<?php echo $row->hotel_id; ?>/<?php echo $row->result_id; ?>/1/<?php echo $row->result_id; ?>"><input type="image" src="<?php echo WEB_DIR ?>images/hotels/select.jpg" /></a></span>
      <?php 
	  } ?>
      </td>
    <!--rate part plus book button--> 

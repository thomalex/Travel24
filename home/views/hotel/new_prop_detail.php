...
<span style="float:right;">
   ...
   <div class="hotel_result1"  style="width:978px; font-size:12px;">
    ...
    <tr><td> <div id="sliderFrame">
        <div id="slider" style="width:300px !important; background-repeat:no-repeat !important;">
        <?php
		if(isset($hotel_images)) { if($hotel_images != '') { foreach($hotel_images as $imgs) { 
		?>
        <img width="300" height="250"  src="<?php echo $imgs->picts; ?>" />
        <?php } } } ?>
            <!--<a href="http://www.menucool.com/javascript-image-slider" target="_blank">
                <img width="100" height="150" src="<?php echo WEB_DIR; ?>images/image-slider-1.jpg" alt="Welcome to Menucool.com" />
            </a>
            <img width="100" height="150"  src="<?php echo WEB_DIR; ?>images/image-slider-2.jpg" alt="gg" />
            <img width="100" height="150"  src="<?php echo WEB_DIR; ?>images/image-slider-3.jpg" alt="Pure Javascript. No jQuery. No flash." />
            <img  width="100" height="150" src="<?php echo WEB_DIR; ?>images/image-slider-4.jpg" alt="#htmlcaption" />
            <img  width="100" height="150" src="<?php echo WEB_DIR; ?>images/image-slider-5.jpg" />-->
        </div>
      ...
      <tr>
        <td width="128" align="center" style="border-right:1px #CCC solid; border-bottom:1px #CCC solid;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center">
            <?php  if($api == 'hotelspro') {  ?>
            <span style="  background-color:#000; color:#FFF; position:absolute; margin:-22px 0px 0px -56px; width:111px; padding:1px; cursor:pointer;"  onclick="show_dethp<?php echo $i; ?>(<?php echo $rom->result_id; ?>);">+ Cance. Details</span>
            <?php } else { ?><span style="  background-color:#000; color:#FFF; position:absolute; margin:-22px 0px 0px -56px; width:111px; padding:1px; cursor:pointer;"  onclick="show_det<?php echo $i; ?>();">+ Cance. Details</span>
            <?php } ?></td>
...
<?php /*?><div style="float:left; margin-top:20px;  "><?php $this->load->view('right_banner'); ?></div><?php */?>
 ...
 <!--footer-->
    ...
    <!--footer-->
 <link href="<?php echo WEB_DIR; ?>css/js-image-slider.css" rel="stylesheet" type="text/css" />
    <script src="<?php echo WEB_DIR; ?>js/js-image-slider.js" type="text/javascript"></script>
</body>
</html>

						...
						if($Total_FareAmount[$ii][$kk]==$lowest_price)
						{
                            ...
                            <td class="calender_bg_div">
									<?php 
										...
										<?php if(isset($name[$ii][$kk])){echo  "<strong><span title='".'Flight Name: '.$name[$ii][$kk].' Flight Number: '.$airline_code[$ii][$kk]."'>".$Total_FareAmount[$ii][$kk].' EUR'."<br/></span></strong><span style='color:red; line-height:10px;'>* Lowest Price</span>"; }else { echo "" ; } ?>
									</a>
				   ...
				   <?php }
						...
						{?>
							<td class="calender_bg_div">
									...
									<a target="_blank" onmouseover="ghghhg" href="<?php echo WEB_URL.'flight/calendar_flight_detail/'.$flight_id[$ii][$kk]."/".$flight_id1[$ii][$kk] ?>/<?php echo $id ?>/<?php echo $date_id ?>">
										<?php }else{?><a href="#"><?php }?>
									<?php if(isset($name[$ii][$kk])){ echo  "<strong><span title='".'Flight Name: '.$name[$ii][$kk].' Flight Number: '.$airline_code[$ii][$kk]."'>".$Total_FareAmount[$ii][$kk].' EUR'."<br/></span></strong>"; }else { echo "" ; } ?>
									</a>

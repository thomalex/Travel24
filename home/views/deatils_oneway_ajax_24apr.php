		...
		$date_sess_ed=date("m-d-y");
                ...
                <div class="row-fluid">
                    <div class="span4">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <h4 style="margin: 0px;"><?php echo $fetch_result_id['dlocation'][0] ?> - <?php echo $fetch_result_id['alocation'][1] ?> | <?php echo $$fetch_result_id['ddate'][0]?> &nbsp; &nbsp; &nbsp; <?php echo $_SESSION['adults']?> voksen</h4>
                            </div>
                        </div>
                                        ...
                                        <div class="span6">
                                            <div class="row-fluid">
                                                ...
                                                <div class="span5">
                                                    ...
                                                    <input type="text" readonly="readonly" class="span12 top25-rep place-color" value="<?php echo $fetch_result_id['alocation'][1] ?> <?php $time1=explode(' ',$fetch_result_id['adate1'][0]);echo $time[1];?>" style="background-color: #276baa;border: 1px solid #276baa;color:#fff;">
                                                </div>
                                            </div>

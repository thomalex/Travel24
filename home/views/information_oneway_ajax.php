                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr class="success1">
                                                               <td style="border-right:1px solid #DDDDDD;"> <?php $time=explode(' ',$finalinformation['ddate1']);echo $time[0]?></td>
                                                                <td> <?php echo $time[1]?></td>
                                                            </tr>
                                                            
                                                            
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Flight No:</td>
                                                                <td><?php echo $flightnumber?></td>
                                                            </tr>
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Flight Type:</td>
                                                                <td><?php echo $name?></td>
                                                            </tr>
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Total Fare Amount:</td>
                                                                <td><?php echo $totalFareAmount?></td>
                                                            </tr>
                                                            <tr class="success1">
                                                               <td style="border-right:1px solid #DDDDDD;">Total Tax Amount:</td>
                                                                <td><?php echo $totalTaxAmount?></td>
                                                            </tr>
                                                             <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Total Adult:</td>
                                                                <td><?php echo $_SESSION['adults']?></td>
                                                            </tr>
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Total Child:</td>
                                                            ...
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;">Total Passenger:</td>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr class="success1">
                                                                <td style="border-right:1px solid #DDDDDD;"> <?php $time=explode(' ',$finalinformation['ddate1'][$i]);echo $time[0]?> </td>
                                                                <td> <?php echo $time[1]?></td>
                                                            </tr>

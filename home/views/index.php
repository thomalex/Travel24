...
$(document).ready(function(e) {
    var siteUrl='http://localhost/travelingmart/';
	//alert(siteUrl);
});
</script>
        ...
        <div class="container top40">
            <div class="row">
                ...
                <div class="span6 align-right">
                   <div id="flip" class="detail-cross-btn top20" onClick="clickslide()" align="right">Skjul/vis søkeboksen X</div>
                </div>
            </div>
                        ...
                        <div class="row-fluid">
                            <div class="span6">
                                <div class="row-fluid">
                                    ...
                                    <div class="span6">
                                        <label class="radio">
                                         <input type="radio" name="journey_type" value="OneWay" id="optionsRadios1" /><strong>Enkel</strong>
                                    ...
                                    <div class="span6">
                                        <label class="radio">
                                            ...
                                            <input type="radio" name="journey_type" id="roundtrip" value="Calendar" checked ><strong>Tur/ retur</strong>
                                        </label>                                
                                    </div>
                                    <!--<div class="span6">
...
<!--                                        <input style="color:#70a4d1;"  type="date" name="sd" id="datepicker"  />
    ...
    <!-- <span id="out"><input style="color:#70a4d1;"  type="date" name="ed" id="datepicker1"   /></span>-->
                    ...
                    <div class="span5">
                        <div class="row-fluid">
                            <div class="span6">
                                <label><strong>Utreise</strong></label>
...
<!--                                <div class="responsive-calendar cal-bg">
                            ...
                            <div class="span6">
                                <label><strong>Hjemreise</strong></label>
...
$("#Search_flight").submit(function(event) {
    ...
    var loder='<div id="loder" style="margin-left:350px;"><img src="<?php echo WEB_DIR; ?>images/1c5b8_loading_big_transparent.gif" width="400" height="400" /></div>';

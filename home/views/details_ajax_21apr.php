                                        ...
                                        <div class="span6">
                                            <div class="row-fluid">
                                                <div class="span5">
                                                    ...
                                                    <input type="text" class="span12 place-color" placeholder="<?php echo $locationIdDeparture ?> <?php echo $interval_layover->h.':'.$interval_layover->i?>" style="background-color: #276baa;border: 1px solid #276baa; color:#fff;">
                                                </div>
                                                ...
                                                <div class="span5">
                                                    ...
                                                    <input type="text" class="span12 top25-rep place-color" placeholder="<?php echo $locationIdArival1 ?> <?php echo $interval_layover1->h.':'.$interval_layover1->i?>" style="background-color: #276baa;border: 1px solid #276baa;color:#fff;">
                                                </div>
                                            </div>
                                            <div class="row-fluid">
                                                <div class="span5">
                                                    <label><?php echo $tocity->city;?></label>
                                                    <input type="text" class="span12 place-color" placeholder="<?php echo $locationIdDepartureret ?> <?php echo $interval_layover_ret->h.':'.$interval_layover_ret->i?>" style="background-color: #958c29;border: 1px solid #958c29;color:#fff;">
                                                </div>
                                                <div class="span2 top300">
                                                ...
                                                <div class="span5">
                                                    ...
                                                    <input type="text" class="span12 top25-rep place-color" placeholder="<?php echo $locationIdArival1ret ?> <?php echo $interval_layover1_ret->h.':'.$interval_layover1_ret->i?>" style="background-color: #958c29;border: 1px solid #958c29;color:#fff;">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6">
